...
jQuery(document).ready(function($){
    ...
    //$('#particles-js1').css('display', 'none');
    if (jQuery('#particles-active').hasClass('swiper-slide-active')) {

        $('#particles-js1').css('display', 'block');
    }else {
        $('#particles-js1').css('display', 'none');
    }
    "use strict";
    ...
    $window.on('mousewheel DOMMouseScroll', function(event){
        if (jQuery('#particles-active').hasClass('swiper-slide-active')) {
            ...
            jQuery('#particles-js1').fadeOut('5000');
        }else {
            jQuery('#particles-js1').fadeIn('5000');
        }
