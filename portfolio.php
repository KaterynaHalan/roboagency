<?php require_once('header.php'); ?>
    ...
    <div id="wrapper" style="background: #000; min-height: 100%;padding-bottom: 20px;">
        ...
        <div id="post-727">
            ...
            <div class="PortfolioFilter is-block-reveal PortfolioFilter-about">
                <a href="about.php">Про компанию</a>
                <a href="clients.php">Наши клиенты</a>
